...
## 2 Dataset Download
LaDe is composed of two subdatasets: i) [LaDe-D]([Anonymous-LaDe/Anonymous-LaDe](https://huggingface.co/datasets/Anonymous-LaDe/Anonymous-LaDe)), which comes from the package delivery scenario.
ii) [LaDe-P]([Anonymous-LaDe/Anonymous-LaDe](https://huggingface.co/datasets/Anonymous-LaDe/Anonymous-LaDe)), which comes from the package pickup scenario. To facilitate the utilization of the dataset, each sub-dataset is presented in CSV format.
